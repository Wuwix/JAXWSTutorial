...
import com.wuwix.service.PersonService;
 ...
 * 
 */
@WebServiceClient(name = "PersonServiceImplService", targetNamespace = "http://service.wuwix.com/", wsdlLocation = "http://localhost:8888/ws/pers?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICEIMPLSERVICE_QNAME = new QName("http://service.wuwix.com/", "PersonServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/ws/pers?wsdl");
    ...
    public com.wuwix.service.PersonService getPersonServiceImplPort() {
        return super.getPort(new QName("http://service.wuwix.com/", "PersonServiceImplPort"), com.wuwix.service.PersonService.class);
    }
     ...
     */
    @WebEndpoint(name = "PersonServiceImplPort")
    public com.wuwix.service.PersonService getPersonServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.wuwix.com/", "PersonServiceImplPort"), PersonService.class, features);
    }
